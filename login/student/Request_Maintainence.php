								...
								<table class="m-auto">
									<tr class="row">
										...
										<td class="col-12">
											...
											<textarea type="text" name="maintanence_txt" class="form-control" id="details" aria-describedby="basic-addon3" rows="5" cols="30"></textarea>
										</td>
									</tr>
									<tr class="text-center pt-5">
										<td colspan="2" class="pt-5">
											<input type="submit" class="btn btn-colo box-sh mx-1 w-1" name="maintenance_room"></a>
