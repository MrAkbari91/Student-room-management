		...
		<div class="col-md-6 m-auto pt-5 pb-5 border-bg">
			<div>
				...
				<div class="w-75 m-auto text-center">
					<div>
						<label class="label_text" for="Category">Your Cancelation Report has been sent to the administiator<span class="text-danger">*</span></label>
						<div class="row m-0">
					...
					<div class="d-flex justify-content-center">
						<a href="Cancel_Room_Request.php"><button class="btn btn-colo box-sh mx-1 w-1">Back</button></a>
					</div>
				</div>
			</div>
		</div>
