    ...
    ?>
							...
							<form action="insert.php" method="post">
								<table class="m-auto">
									<tr>
										...
										<td class="pl-3">
											<select class="selct-type" id="Category" name="Category" onclick="selectbuilding()">
												<option value="With Roommate">With Roommate</option>
												<option value="Without Roommate">Without Roommate</option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr class="text-center pt-5">
										<td colspan="2" class="pt-5">
											<input type="submit" value="book" name="book_room" class="btn btn-colo box-sh mx-1 w-1">
		...
		<script>
			function selectbuilding(){
				var conceptName = document.getElementById("Category").value;
				if(conceptName == "With Roommate"){
					var txt = "<option value=''>Select building</option><option value='1'>Building 1</option><option value='2'>Building 2</option><option value='3'>Building 3</option>";
					document.getElementById("Building").innerHTML = txt;
				}else{
					var txt = "<option value=''>Select building</option><option value='4'>Building 4</option><option value='5'>Building 5</option>";
					document.getElementById("Building").innerHTML = txt;
				}
			}
			...
			function selectroom(){
				...
				if(conceptName == "1"){
					var i=1;
					var txt ="<option value=''>Select Room</option>"
					for(i=1;i<=20;i++){
